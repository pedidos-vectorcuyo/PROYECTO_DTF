    ...
    return (
        <div className="flex items-center justify-center min-h-[calc(100vh-200px)]">
            <div className="w-full max-w-[400px] bg-surface border border-gray-border rounded-card p-8 shadow-sm">
                ...
                {/* Google Sign-In — solo se monta si GOOGLE_ENABLED y GoogleOAuthProvider está disponible */}
                {GOOGLE_ENABLED && (
                    <>
                        <div className="mb-5">
                            {isGoogleLoading ? (
                                <div className="w-full flex items-center justify-center h-[44px] text-sm text-text-secondary">
